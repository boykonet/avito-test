...
Этот репозиторий - это решение тестового задания (https://github.com/avito-tech/autumn-2021-intern-assignment) на позицию golang бэкенд-разработчика.

Чтобы запустить программу и проверить ее работоспособность 
